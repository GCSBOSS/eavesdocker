...
//     filters: [
//         { field: 'level', eq: 'info' },
//         { field: 'abc.level', neq: 'info' },
//         { field: 'abcd.[0].level', in: [ 'dbc' ] },
//         { field: 'abcd.[0].level', nin: [ 'dbc' ] },
//         { containers: [ 'id123123' ] }
//     ]
// };
...
const eventSource = new EventSource("/live", { withCredentials: true });
